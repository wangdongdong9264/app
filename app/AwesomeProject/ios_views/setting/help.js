  ...
  render(){
    return(
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.text}>A: 当身处陌生环境,又到饭点的情况</Text>
        ...
        <Text style={styles.text}>A: 如有其他问题,可发送邮件到wangdongdong9264@hotmail.com </Text>
        <Text style={styles.text}>looooooooooool</Text>
      </ScrollView>
    );
  }
}
